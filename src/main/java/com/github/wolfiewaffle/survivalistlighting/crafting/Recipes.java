...
public class Recipes {
	public static void init() {
		...
		if (ModConfig.configCokeTorches) GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Item.getItemFromBlock(ModBlocks.torch_coke_unlit)), "A", "B", 'A', "fuelCoke", 'B', "stickWood"));
		...
		if (ModConfig.configLightInInventory) {
			...
			for (String string : ModConfig.configFreeLightItems) {
				...
				// Coke torches
				if (ModConfig.configCokeTorches) GameRegistry.addRecipe(new ShapelessReuseRecipe(new ItemStack(ModItems.torch_coke_lit), new ItemStack(ModItems.torch_coke_unlit), itemStack));
				...
				if (ModConfig.configStoneTorches && SurvivalistLighting.isTconInstalled) {
					...
					// Stone coke torches
					if (ModConfig.configCokeTorches) GameRegistry.addRecipe(new ShapelessReuseRecipe(new ItemStack(ModItems.torch_stone_coke_lit), new ItemStack(ModItems.torch_stone_coke_unlit), itemStack));
				}
			}
			...
			for (String string : ModConfig.configLightItems) {
				...
				if (itemStack.getItem().isDamageable()) {
					...
					// Coke torches
					if (ModConfig.configCokeTorches) GameRegistry.addRecipe(new ShapelessDamageRecipe(new ItemStack(ModItems.torch_coke_lit), new ItemStack(ModItems.torch_coke_unlit), itemStack));
					...
					if (ModConfig.configStoneTorches && SurvivalistLighting.isTconInstalled) {
						...
						// Stone coke torches
						if (ModConfig.configCokeTorches) GameRegistry.addRecipe(new ShapelessDamageRecipe(new ItemStack(ModItems.torch_stone_coke_lit), new ItemStack(ModItems.torch_stone_coke_unlit), itemStack));
					}
				...
				// Item is not damageable
					...
					// Coke torches
					if (ModConfig.configCokeTorches) GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ModItems.torch_coke_lit), new ItemStack(ModItems.torch_coke_unlit), itemStack));
					...
					if (ModConfig.configStoneTorches && SurvivalistLighting.isTconInstalled) {
						...
						// Stone coke torches
						if (ModConfig.configCokeTorches) GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ModItems.torch_stone_coke_lit), new ItemStack(ModItems.torch_stone_coke_unlit), itemStack));
					}
				}
			}
		}
