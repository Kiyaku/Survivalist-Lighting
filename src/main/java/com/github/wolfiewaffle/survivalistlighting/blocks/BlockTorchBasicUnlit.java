...
import com.github.wolfiewaffle.survivalistlighting.tileentity.TileEntityTorchLit;
import com.github.wolfiewaffle.survivalistlighting.tileentity.TileEntityTorchUnlit;
...
public class BlockTorchBasicUnlit extends BlockTorch implements ITileEntityProvider {
	...
	public BlockTorchBasicUnlit(String name, int maxFuel, Block litVariant, boolean includeInCreative) {
